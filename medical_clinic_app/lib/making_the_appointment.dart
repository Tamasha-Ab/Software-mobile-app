...
//       final appointment = {
//         'doctorName': widget.doctorDetails['fullName'], // Use doctorName instead of doctorId
//         'date': selectedDate!,
//         'time': selectedTime!,
//         'patientName': _patientNameController.text,
//         'patientEmail': _patientEmailController.text,
//         'patientPhone': _patientPhoneController.text,
//         'patientUsername': _patientUsernameController.text,
//       };

//       print('Submitting appointment with data: $appointment');
...
//     final availability = widget.doctorDetails['availability'] as List<dynamic>?;
...
//                     DropdownButtonFormField<String>(
//                       value: selectedTime,
//                       items: (selectedDate != null && availability != null)
//                           ? availability
//                               .firstWhere((entry) => entry['day'] == selectedDate)['timeSlots']
...
//                         backgroundColor: const Color.fromARGB(255, 99, 181, 249),
//                       ),
//                       child: const Text('Press to get Patient Information'),
//                     ),
//                     const SizedBox(height: 20),
//                     TextFormField(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: (selectedDate != null && availability != null)
                          ? availability
                              .firstWhere((entry) => entry['day'].toLowerCase() == selectedDate!.toLowerCase())['timeSlots']
                              .map<DropdownMenuItem<String>>((slot) {
                                return DropdownMenuItem<String>(
                                  value: '${slot['startTime']} - ${slot['endTime']}',
                                  child: Text('${slot['startTime']} - ${slot['endTime']}'),
