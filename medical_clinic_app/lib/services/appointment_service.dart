  ...
  Future<String> bookAppointment(Map<String, dynamic> appointmentData) async {
    try {
      ...
      if (response.statusCode == 201) {
        ...
        if (response.statusCode == 400 && errorResponse['message'] == 'All appointment slots are filled') {
          return 'All appointment slots are filled.';
        } else if (response.statusCode == 400 && errorResponse['message'] == 'This time slot is already booked.') {
