        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              doctorDetails['availability'] != null &&
                      doctorDetails['availability'] is List
                  ? Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: (doctorDetails['availability'] as List<dynamic>)
                          .map((entry) {
                        return Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            ...((entry['timeSlots'] as List<dynamic>).map((slot) {
                              return Text(
